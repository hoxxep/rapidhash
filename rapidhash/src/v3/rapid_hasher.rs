...
impl<const AVALANCHE: bool, const SPONGE: bool, const COMPACT: bool, const PROTECTED: bool> BuildPortableHasher for RapidBuildHasher<AVALANCHE, SPONGE, COMPACT, PROTECTED> {
    type PortableHasher = RapidHasher<AVALANCHE, SPONGE, COMPACT, PROTECTED>;

    #[inline(always)]
    fn build_hasher(&self) -> Self::PortableHasher {
        Self::PortableHasher::new_precomputed_seed(self.seed, self.secrets)
    }
    ...
    fn hash_one<T: PortableHash>(&self, x: T) -> u64
    where
        Self: Sized,
...
impl<const AVALANCHE: bool, const SPONGE: bool, const COMPACT: bool, const PROTECTED: bool> PortableHasher for RapidHasher<AVALANCHE, SPONGE, COMPACT, PROTECTED> {
    #[inline(always)]
    fn finish(&self) -> u64 {
        self.finish_const()
    }
